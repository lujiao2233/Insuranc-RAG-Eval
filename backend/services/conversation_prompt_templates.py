...
10. 如果涉及具体产品、合同、责任、方案、条款对象，必须使用切片中明确出现的实体名称（如产品名称、合同名称、保险条款全称等），不要擅自引入新实体。禁止使用"条款要求""该保险""本产品""上述方案"等模糊指代，必须写出完整实体名称。例如：不要写"条款要求..."，应写"《XX保险条款》要求..."或"XX保险规定..."。
...
7. 涉及具体产品、合同、保障责任、规则对象时，必须使用切片中明确出现的实体名称（如产品名称、保险条款全称等），不得自行脑补。禁止使用"条款要求""该保险""本产品"等模糊指代，必须写出完整实体名称，如"《XX保险条款》规定..."。
